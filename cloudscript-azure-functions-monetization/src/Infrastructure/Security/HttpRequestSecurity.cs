...
namespace Serhat.Forge.CloudScript.Infrastructure.Security;

public static class HttpRequestSecurity
{
...
public static class PlayFabRequestSecurity
{
    public static PlayFabRequestParseResult<TPayload> ParseEnvelope<TPayload>(
        string requestBody,
        ...
        where TPayload : class
    {
        ...
        {
            return PlayFabRequestParseResult<TPayload>.Invalid("INVALID_REQUEST_FORMAT");
        }
        ...
        if (isPlayFabWrapper)
        {
            ...
            {
                return PlayFabRequestParseResult<TPayload>.Unauthorized("INVALID_PLAYFAB_CONTEXT");
            }
        ...
        else
        {
            ...
            {
                return PlayFabRequestParseResult<TPayload>.Unauthorized("PLAYFAB_CONTEXT_REQUIRED");
            }
        ...
        {
            return PlayFabRequestParseResult<TPayload>.Unauthorized("PLAYER_ID_REQUIRED");
        }

        envelope.FunctionName = actualFunctionName;
        envelope.CorrelationId = NormalizeCorrelationId(envelope.CorrelationId);
        return PlayFabRequestParseResult<TPayload>.Success(envelope);
    }
...
public sealed class PlayFabRequestParseResult<TPayload> where TPayload : class
{
    private PlayFabRequestParseResult(
    ...
    public static PlayFabRequestParseResult<TPayload> Success(RequestEnvelope<TPayload> envelope) =>
        new(envelope, false, null);

    public static PlayFabRequestParseResult<TPayload> Invalid(string errorCode) =>
        new(null, false, errorCode);

    public static PlayFabRequestParseResult<TPayload> Unauthorized(string errorCode) =>
